...
#         try:
#             df = pd.read_csv(csv_file, delimiter=delimiter, on_bad_lines='skip', encoding='ISO-8859-1')
#         except UnicodeDecodeError:
#             df = pd.read_csv(csv_file, delimiter=delimiter, on_bad_lines='skip', encoding='cp1252')
